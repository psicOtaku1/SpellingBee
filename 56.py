...
easy=['heart','heard','February','busy','built','woman','women','answer','early','fruit','group','popular','calendar','caught','eight','continue','learn','walk','library','question','regular','different','difficult','believe','language','maths','science','english','spanish','country','city','town','angry']
medium=['bicycle','business','occasionally','position','often','guide','favourite','consider','recent','crawl','knowledge','island','medicine','though','various','disappear','defend','argue']
hard=['onomatopoeia','rhythm','peculiar','although','accidentally','possession','pressure','moreover','soldier','stomach','symbol','vehicle','rhyme','recommend','harass','identity','especially','determined','dictionary','equipment']
